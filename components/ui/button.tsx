  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        destructive: "bg-accent text-white shadow-sm hover:bg-red-700",
        outline: "border border-input bg-background shadow-sm hover:bg-accent hover:text-white",
        secondary: "bg-secondary text-white shadow-sm hover:bg-blue-600",
        ghost: "hover:bg-accent hover:text-white",
        link: "text-primary underline-offset-4 hover:underline",
        whatsapp: "bg-[#25d366] text-white shadow-sm hover:bg-[#1ebe5a]",
        instagram: "bg-gradient-to-r from-[#e1306c] via-[#fd1d1d] to-[#f56040] text-white shadow-sm hover:opacity-90",
      },
      size: {
